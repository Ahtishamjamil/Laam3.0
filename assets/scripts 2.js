...
/////////////////////////////////////
  ...
  //Product-page-accordion-js
    $(document).ready(function() {
      $('.accordion').accordion({
      defaultOpen: 'section_description',
...
$(".swatch-element.stitched").click(function () {
  $(".active-content").show();
});
...
$(".customized, .customised, .custom-size, .custom-order, .custom").click(function () {
...
$(".xs, .s, .m, .l, .xl, .unstitched").click(function () {
