...
$container.find('#carousel').flexslider({
  ...
  $container.find('.product_images').flexslider({
    ...
    if (variant && variant.featured_image && $product.is(":visible") && (changeUrl || isFeaturedProduct == true)) {
...
//         }
    ...
    if ( variant.compare_at_price > variant.price ) {
		...
		if(typeof Currency !== 'undefined' && comparePrice.length && shopCurrency && cookieCurrency){
			...
			comparePrice.html(Shopify.formatMoney(convertedPrice, Currency.moneyFormats[cookieCurrency].money_format)).show();
		}
 ...
 /////////// Related products /////////////////
    ...
    $container.find(".main-product-select .single-option-selector").on("change", function(){
     ...
     if(flag){
        ...
        var optionsLength = $container.find('#product-select-' + productJSON.id).length;
  ...
  var featuredProducts = $('#featured-products-section-'+sectionId+'');
    if(featuredProducts.length){
      ...
      $(document).ready(function(){
        // if desktop width show forward backward arrows for carousel
        if($(window).width() > 786){
        ...
        // if width is mobile then hide forward backwards arrows
        }else{
          featuredProducts.owlCarousel({
            margin: 0,
              nav:false,
  ...
  theme.PasswordSection = (function() {
    ...
    return PasswordSection;
      ...
      $(document).ready(function() {
        ...
        var infiniteScrollSearch = new Waypoint.Infinite({
          element: $('.search-infinite-wrapper')[0],
          items: '.search-infinite-wrapper > div',
          more: '.load-more__btn',          
		  onBeforePageLoad: function(){
            $('.load-more__icon').show();         
          },
...
// ====================== AJAXINATE ===================
// //infinte scrolling code start here
//   document.addEventListener("DOMContentLoaded", function() {
//     var endlessScroll = new Ajaxinate();
//   });

  
// //infinte scrolling code ends here start here
...
// this is for enabling sticky header
...
$(window).scroll(function (event) {
  ...
  if(scroll == 0){
    if ($(".header_bot").hasClass("sticky")) {
      $(".header_bot").removeClass("sticky", {duration: 1000});
    }
    
  }else{
    $(".header_bot").addClass("sticky", {duration: 1000});
  }
});
...
/////////////////////////////////////
  ...
  function fadingScrollEffect(Id, scrollHeight){
    document.addEventListener('DOMContentLoaded', function() {
      jQuery(function($){
        let mywindow = $(window);
        ...
        if (mypos > scrollHeight) {
        if(mywindow.scrollTop() > mypos) {
          $(Id).addClass('headerup');
        } else {
          $(Id).addClass('headerup');
        }
      }
  ...
  fadingScrollEffect('#shopify-section-1593902400917', 40);
  fadingScrollEffect('#shopify-section-1593902546420', 40);
  fadingScrollEffect('#shopify-section-1593955033568', 80);
  fadingScrollEffect('#shopify-section-1593410881868', 80);
  fadingScrollEffect('#shopify-section-1594124607573', 160);
  fadingScrollEffect('#shopify-section-1593779583459', 160);
  fadingScrollEffect('#shopify-section-1593410784387', 200);
  fadingScrollEffect('#shopify-section-1594129473778', 200);
  fadingScrollEffect('#shopify-section-1593782511881', 240);
  fadingScrollEffect('#shopify-section-1593784844040', 240);
  fadingScrollEffect('#shopify-section-1594276233867', 280);
  fadingScrollEffect('#shopify-section-1594215929217', 280);
  fadingScrollEffect('#shopify-section-1568715038078', 320);
  fadingScrollEffect('#shopify-section-1568715197451', 320);
  fadingScrollEffect('#shopify-section-1557473743032', 360);
  fadingScrollEffect('#shopify-section-1568715479767', 360);
  fadingScrollEffect('#shopify-section-icon-buttons', 400);
  fadingScrollEffect('#shopify-section-footer', 400);
    ...
    $(".mob-search").click(function () {
        $("div#custom_search").show();
    });
    
    $(document).click(function (e) {
        if (!$(e.target).hasClass("mob-search") 
            && $(e.target).parents(".mob-srch, .i.fa.fa-close.serch-close").length === 0) 
        {
            $("div#custom_search").hide();
        }
    });
...
$(document).click(function (e) {
  if (!$(e.target).hasClass("share-it") 
      && $(e.target).parents(".social-sharing, .i.fa.fa-close.serch-close").length === 0) 
  {
      $(".share").hide();
  }
});
...
$(document).ready(function(){
  ...
  $(".swatch").eq(1).addClass("active-content");
  $(".swatch").eq(2).addClass("active-content");
});

$(".swatch-element.stitched, .plain-stitching, .embellished-stitching").click(function () {
  $(".active-content").show();
});
$(".swatch-element.unstitched").click(function () {
  $(".active-content").hide();
});
$(".swatch-element.un-stitched").click(function () {
  $(".active-content").hide();
});
...
$(".customized, .customised, .custom-size, .custom-order, .custom,.custom.order, .un-stitched, .Custom.Size, .custom.size ").click( function () {
  $(".cstm-size-diagram-container").show();
  //$('input[name="option-1"]').prop('checked', true);

});

$(document).ready(function(){
    $(".custom-size").addClass("intro");

});
// $(".stitched, .customized").click(function () {
//   $(".cstm-size-diagram-container").show();
// });

$(".xs, .s, .m, .l, .xl, .unstitched, .unavailable").click(function () {
  $(".cstm-size-diagram-container").hide();
  });


// Back Button on Collection pages
...
$(document).ready(function(){
  $(".aaa-ask-the-wishlist-grid.active-wish").click(function(){
    $(".aaa-ask-the-wishlist-grid i").toggleClass("fa fa-heart");
  });
});
...
//page-gallery-scrollable3
$('.page-galleryimage').owlCarousel({
  margin: 10,
              nav:false,
              navRewind:false,
              dots:false,
